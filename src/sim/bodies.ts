...
export const DEFS: BodyDef[] = [
  { name: 'Sun', mass: SOL, radius: 0.12, color: '#ffcf4d' },
  { name: 'Mercury', mass: 0.166 * M_E, radius: 0.03, color: '#b7b2a8' },
  { name: 'Venus', mass: 0.815 * M_E, radius: 0.05, color: '#e6c98f' },
  { name: 'Earth', mass: M_E, radius: 0.05, color: '#4a90e2' },
  { name: 'Mars', mass: 0.107 * M_E, radius: 0.045, color: '#d1593f' },
  { name: 'Jupiter', mass: 317.8 * M_E, radius: 0.1, color: '#d9a066' },
  { name: 'Saturn', mass: 95.2 * M_E, radius: 0.09, color: '#e3c87a' },
  { name: 'Uranus', mass: 14.536 * M_E, radius: 0.08, color: '#9fd6e3' },
  { name: 'Neptune', mass: 17.147 * M_E, radius: 0.08, color: '#4f7cdd' },
];
